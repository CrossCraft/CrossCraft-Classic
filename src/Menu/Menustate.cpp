    ...
    if (!textureMenu) {
        ...
        if (selIdx != 2) {
            fontRenderer->add_text(
                "Texture Packs",
                {SCREEN_CENTER + 1 -
                     fontRenderer->calculate_size("Texture Packs") / 2,
                 134 - 24 * 2},
                shadow, -19);
            fontRenderer->add_text(
                "Texture Packs",
        ...
        fontRenderer->add_text("CrossCraft Classic 1.3.0 (0.30)",
                               {3, SCREEN_H - 11},
        ...
        fontRenderer->add_text(
            "Texture Packs:",
            {SCREEN_CENTER - fontRenderer->calculate_size("Texture Packs:") / 2,
             SCREEN_H - 16},
            white, -20);
