...
namespace CrossCraft
{
    ...
    auto PlaceAction::place(std::any d) -> void
    {
        ...
        for (u32 i = 0; i < NUM_STEPS; i++)
        {
            ...
            for (int i = 0; i < 2; i++)
            {
                ...
                for (int c = 0; c < 2; c++)
                {
                    ...
                    if ((ivec == posivec || ivec == posivec2 || ivec == posivec3) &&
                        (bk != Block::Sapling && bk != Block::Flower1 && bk != Block::Flower2 && bk != Block::Mushroom1 && bk != Block::Mushroom2))
                        return;
            ...
            auto posivec = glm::ivec3(static_cast<s32>(pos.x), static_cast<s32>(pos.y),
